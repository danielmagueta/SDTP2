...
sshpass -f password ssh -o StrictHostKeyChecking=no sd301@l040101-ws03.ua.pt 'cd test/AirLiftTP2/dirPlane ; java serverSide.main.PlaneMain 22302 l040101-ws01.ua.pt 22300'