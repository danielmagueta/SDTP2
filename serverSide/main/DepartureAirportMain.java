...
public class DepartureAirportMain
{
   ...
   */
   ...
   {
      DepartureAirport dAirport;                                     // departure airport (service to be rendered)
      DepartureAirportInterface dAirportInter;                       // interface to the departure airport
     ...
     /* service is established */
      ...
      dAirport = new DepartureAirport (reposStub);                                  // service is instantiated
      dAirportInter = new DepartureAirportInterface (dAirport);                     // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      { try
        { sconi = scon.accept ();                                         // enter listening procedure
          cliProxy = new DepartureAirportProxy (sconi, dAirportInter);    // start a service provider agent to address
