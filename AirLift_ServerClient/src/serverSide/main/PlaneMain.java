...
public class PlaneMain
{
   ...
   */
   ...
   public static void main (String [] args)
   {
      ...
      PlaneInterface planeInter;                                     // interface to the Plane
     ...
     /* service is established */
      ...
      planeInter = new PlaneInterface (plane);                                      // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      PlaneProxy cliProxy;                                // service provider agent

      waitConnection = true;
      while (waitConnection)
      { try
        { sconi = scon.accept ();                                         // enter listening procedure
          cliProxy = new PlaneProxy (sconi, planeInter);    // start a service provider agent to address
