...
public class DepartureAirportProxy extends Thread implements PassengerCloning, HostessCloning, PilotCloning
{
  /**
   ...
   */
   ...
   private DepartureAirportInterface dAirportInter;
   ...
   */
   ...
   public DepartureAirportProxy (ServerCom sconi, DepartureAirportInterface dAirportInter)
   {
      ...
      this.sconi = sconi;
      this.dAirportInter = dAirportInter;
   }
   ...
   */
   ...
   public void run ()
   {
     ...
     /* service providing */
      ...
      try
      { outMessage = dAirportInter.processAndReply (inMessage);         // process it
      }
