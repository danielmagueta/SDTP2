...
sshpass -f password ssh -o StrictHostKeyChecking=no sd301@l040101-ws02.ua.pt 'cd test/AirLiftTP2/dirDepartureAirport ; java serverSide.main.DepartureAirportMain 22301 l040101-ws01.ua.pt 22300'
