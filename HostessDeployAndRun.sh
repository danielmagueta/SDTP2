...
sshpass -f password ssh -o StrictHostKeyChecking=no sd301@l040101-ws06.ua.pt 'cd test/AirLiftTP2/dirHostess ; java clientSide.main.HostessMain l040101-ws02.ua.pt 22301 l040101-ws04.ua.pt 22303 l040101-ws08.ua.pt 22300'
