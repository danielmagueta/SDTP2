...
sshpass -f password ssh -o StrictHostKeyChecking=no sd301@l040101-ws07.ua.pt 'cd test/AirLiftTP2/dirPassenger ; java clientSide.main.PassengerMain l040101-ws02.ua.pt 22301 l040101-ws03.ua.pt 22302 l040101-ws04.ua.pt 22303 l040101-ws01.ua.pt 22300'