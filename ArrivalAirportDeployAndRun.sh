...
sshpass -f password ssh -o StrictHostKeyChecking=no sd301@l040101-ws04.ua.pt 'cd test/AirLiftTP2/dirArrivalAirport ; java serverSide.main.ArrivalAirportMain 22303 l040101-ws08.ua.pt 22300'
